...
ACCESS_TOKEN_EXPIRY_MINUTES = _env_int("ACCESS_TOKEN_EXPIRY_MINUTES", 5)
REFRESH_TOKEN_EXPIRY_DAYS = _env_int("REFRESH_TOKEN_EXPIRY_DAYS", 30)
...
MAX_CONNECTIONS_PER_USER = _env_int("MAX_CONNECTIONS_PER_USER", 8)
...
DEFAULT_VOICE_CHANNEL_NAME = _env("DEFAULT_VOICE_CHANNEL_NAME", "General")

RECOVERY_PASSPHRASE_LENGTH = 10
RECOVERY_EXPIRY_DAYS = 2
